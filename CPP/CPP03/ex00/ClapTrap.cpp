...
ClapTrap::ClapTrap(const ClapTrap &ref) : mName(ref.mName), mHitPoints(ref.mHitPoints), mEnergyPoints(ref.mEnergyPoints), mAttackDamage(ref.mAttackDamage)
{
...
{
    std::cout << "ClapTrap <" << mName << "> has taken <" << amount << "> of damege\n";
...
{
    std::cout << "ClapTrap <" << mName << "> has been repaired and has gain <" << amount << "> energy points\n";
